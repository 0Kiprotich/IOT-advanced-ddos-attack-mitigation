...
class SimpleMonitor13(switchm.SimpleSwitch13):
    ...
    def flow_trainingDecisionTree(self):

        self.logger.info("KNN Training ...")
        modelDB = 'dt_model.pkl'
    ...
    def flow_trainingKNN(self):

        self.logger.info("KNN Training ...")
        modelDB = 'knn_model.pkl'
    ...
    def flow_training(self):
        ...
        self.flow_trainingKNN()
        #self.flow_trainingDecisionTree()
